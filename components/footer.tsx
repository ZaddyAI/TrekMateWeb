        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Your trusted companion for Himalayan adventures. Discover, book, and experience the best accommodations in
              Nepal's most beautiful trekking destinations.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">info@trekmate.com</span>
              </li>
              <li className="flex items-center space-x-2">
